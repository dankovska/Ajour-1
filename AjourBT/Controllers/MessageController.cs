...
//[RequireHttps] //apply to all actions in controller
    ...
    public class MessageController : Controller
    {
        ...
        public ActionResult GetMessagesForRole(int tab, string role, string actionNameForPagination, string searchString = "")
        {
        ...
        public ActionResult GetMessagesDataForRole(int tab, string role, string actionNameForPagination, string searchString = "", int page = 1)
        {
            ...
            List<IMessage> selectedMessages = repository.Messages.ToList();
        ...
        public List<IMessage> SearchPUMessageData(List<IMessage> messages, string searchString)
        {
        ...
        public List<IMessage> SearchOtherRoleMessageData(List<IMessage> messages, string searchString, string role)
        {
            List<IMessage> selected = messages.OrderByDescending(m => m.TimeStamp).
                                           Where(m => m.Role == role && (
