...
namespace AjourBT.Filters
{
    ...
    public sealed class InitializeSimpleMembershipAttribute : ActionFilterAttribute
    {
        ...
        {
            AjourDbContext context = new AjourDbContext();

            public SimpleMembershipInitializer()
            {
                string DBInitType = WebConfigurationManager.AppSettings["DBInitType"].ToString();
                switch (DBInitType)
                {
                    case ("InitForTest"):
                        InitForTest();
                ...
                WebConfigurationManager.AppSettings["TimeZoneId"].ToString();
            }
            ...
            public void InitForTest()
            {
       ...
       
             {
                ...
                new Employee {EmployeeID = 71,FirstName = "Phillip", LastName = "Morris", DepartmentID = 6, EID = "moph", DateEmployed = new DateTime(2011,11,01), IsManager = true, BirthDay = new DateTime(1987,11,10), FullNameUk = "Джоні Роус", Comment = "Happy Birthday!!!", PositionID = 2,CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(),Sicknesses = new List<Sickness>()},
                new Employee {EmployeeID = 72,FirstName = "Brandon",LastName = "Ferguson",DepartmentID = 6, EID = "rlan", DateEmployed = new DateTime(2013,04,11), IsManager = false, BirthDay = new DateTime(1987,11,10), FullNameUk = "Джоні Роус", Comment = "Happy Birthday!!!", PositionID = 2,CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(),Sicknesses = new List<Sickness>()},          
                new Employee {EmployeeID = 73,FirstName = "Stephanie",LastName = "Armstrong",DepartmentID = 6, EID = "jann", DateEmployed = new DateTime(2013,09,11), IsManager = false, BirthDay = new DateTime(1987,11,10), FullNameUk = "Джоні Роус", Comment = "Happy Birthday!!!", PositionID = 2,CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(),Sicknesses = new List<Sickness>()},
                new Employee {EmployeeID = 74,FirstName = "Jerry",LastName = "Garza",DepartmentID = 6, EID = "jasn", DateDismissed = new DateTime(2013,01,01), DateEmployed = new DateTime(2009,04,17), IsManager = false, BirthDay = new DateTime(1987,11,10), FullNameUk = "Джоні Роус", Comment = "Happy Birthday!!!", PositionID = 2,CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(),Sicknesses = new List<Sickness>()},
                ...
                new Employee {EmployeeID = 79,FirstName = "Donald",LastName = "Hawkins",DepartmentID = 7, EID = "jdun", DateEmployed = new DateTime(2011,04,11), IsManager = false, BirthDay = DateTime.Now.ToLocalTimeAzure(), FullNameUk = "Джоні Роус", Comment = "Happy Birthday!!!", PositionID = 2,CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(),Sicknesses = new List<Sickness>()},
            ...
            {          
                ...
                new BusinessTrip { BusinessTripID = 51, StartDate = DateTime.Now.ToLocalTimeAzure().ToLocalTimeAzure().Date.AddDays(-50), EndDate = DateTime.Now.ToLocalTimeAzure().ToLocalTimeAzure().Date.AddDays(-13), OrderStartDate = DateTime.Now.ToLocalTimeAzure().ToLocalTimeAzure().Date.AddDays(-51), OrderEndDate = DateTime.Now.ToLocalTimeAzure().ToLocalTimeAzure().Date.AddDays(-11), Responsible= "mter", DaysInBtForOrder = 40, Manager="lmor", Purpose = "Meeting", UnitID = 1,LastCRUDedBy = "ncru", LastCRUDTimestamp = DateTime.Now.ToLocalTimeAzure().ToLocalTimeAzure().Date.AddDays(-60), Status= BTStatus.Confirmed | BTStatus.Reported, EmployeeID = 5, LocationID = 1, Comment = "confirmed and reported" },
                ...
                new BusinessTrip { BusinessTripID = 60, StartDate = new DateTime(2013,02,02), EndDate = new DateTime (2013,03,05), OrderStartDate = new DateTime(2013,02,01), OrderEndDate = new DateTime (2013,03,06), DaysInBtForOrder = 34, LastCRUDedBy = "ncru", LastCRUDTimestamp = new DateTime(2013,09,21), Status= BTStatus.Confirmed | BTStatus.Reported, EmployeeID = 3, LocationID = 2,Responsible= "mter", Comment = "confirmed and reported", Manager = "khal", UnitID = 1,Purpose = "meeting" },
            ...
            {
                new VisaRegistrationDate {EmployeeID=5, RegistrationDate=new DateTime(2013,01,01), City = "Lviv", RegistrationNumber = "11486", RegistrationTime = "08:00",  VisaType="V_D08"},
                ...
                List<Visa> visas = new List<Visa>
            {
                ...
                new Visa { EmployeeID = 75, VisaType = "V_C07", StartDate = new DateTime(2012,02,13), DueDate = new DateTime (2012,05,13), Days = 20, DaysUsedInBT = 5, DaysUsedInPrivateTrips = 0, CorrectionForVisaDays = 0, Entries = 4, EntriesUsedInBT = 2, EntriesUsedInPrivateTrips = 0, CorrectionForVisaEntries = 0, VisaOf = employees.Find(e => e.EmployeeID == 75) },
                ...
                List<Permit> permits = new List<Permit>
            {
                ...
                new Permit { EmployeeID = 46, Number = "01/2012", StartDate = new DateTime(2012, 01,01), EndDate = new DateTime (2013, 08, 08), IsKartaPolaka = true, PermitOf = employees.Find(e => e.EmployeeID == 46)},
                ...
                List<Overtime> overtimes = new List<Overtime>
                {
                    ...
                    new Overtime{OvertimeID = 3, EmployeeID = 3,Date = new DateTime(2013,01,03), ReclaimDate = new DateTime(2013,03,02), DayOff = true, Type = OvertimeType.Paid },
                    new Overtime{OvertimeID = 4, EmployeeID = 4,Date = new DateTime(2013,01,04), ReclaimDate = new DateTime(2013,04,02), DayOff = true, Type = OvertimeType.Paid },
                ...
                ////    new UserProfile{UserId=1, UserName="PowerUser" }
                ////};

                //    context.UserProfiles.Add(userProfile[0]);
                ...
                try
                {
                    ...
                    {
                        WebSecurity.CreateUserAndAccount("ealv", "123456");
                    }
                    #endregion
            ...
            //try
            //{
            //using (var context = new AjourDbContext())
            //{
            ...
            //    if (!WebSecurity.UserExists("adm"))
            //    {
            //        WebSecurity.CreateUserAndAccount("adm", "123456");
            //    }

            //    if (!WebSecurity.UserExists("bt"))
            //    {
            //        WebSecurity.CreateUserAndAccount("bt", "123456");
            //    }
            ...
            //    if (!System.Web.Security.Roles.RoleExists("BT"))
            //    {
            //        System.Web.Security.Roles.CreateRole("BT");
            //    }
            ...
            //    if (!System.Web.Security.Roles.IsUserInRole("adm", "ADM"))
            //    {
            //        System.Web.Security.Roles.AddUserToRole("adm", "ADM");
            //    }

            //    if (!System.Web.Security.Roles.IsUserInRole("bt", "BT"))
            //    {
            //        System.Web.Security.Roles.AddUserToRole("bt", "BT");
            //    }
