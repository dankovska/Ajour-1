    ...
    public static class ResponsibleForLocDisplay
    {
        public static MvcHtmlString CustomResponsibleForLocActionLink(this HtmlHelper helper, Location location)
        {
            if (location != null)
            {
                ...
                //{
                //    return new MvcHtmlString(String.Format("<a id=\"AddResponsibleForLoc\" href=\"{0}{1}\"><span> Add </span></a>", "/Location/AddResponsibleForLoc/", location.LocationID));
                //}
                //else
                //{
                //    return new MvcHtmlString(String.Format("<a class=\"responsibleForLocEditDialog\" id=\"responsibleForLocEdit\" href=\"{0}{1}\">{2}</a>", "/Location/EditResponsibleForLoc/", location.LocationID, location.ResponsibleForLoc));
                //}
