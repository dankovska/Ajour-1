...
namespace AjourBT.Helpers
{
    public static class CustomCheckVisaToBeValid
    {
        ...
        public static MvcHtmlString CheckVisaToBeValid(this HtmlHelper helper, Employee employee, string searchString = "")
        {
            ...
            {
                return new MvcHtmlString(String.Format("<a class=\"ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only\" id=\"AddPrivateTrip\"  data-date-format=\"dd.mm.yy\" href=\"{0}{1}?searchString={2}\"> Add </a>", "/PrivateTrip/Create/", employee.EmployeeID, searchString));
            }
        }
    }
}