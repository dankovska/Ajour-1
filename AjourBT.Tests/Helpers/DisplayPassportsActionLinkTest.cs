...
{  
    ...
    public class DisplayPassportsActionLinkTest
    {
        ...
        public void DisplayPassportsActionLink_EmptyPassportAndSearchStringDa_ProperString()
        {
            ...
            MvcHtmlString expected = new MvcHtmlString("<a id=\"AddDatePassport\" data-date-format=\"dd.mm.yy\" href=\"/Passport/AddDate/1?searchString=Da\">Date</a>");
        ...
        public void DisplayPassportsActionLink_PassportAndEmptySearchString_ProperString()
        {
            ...
            MvcHtmlString expected = new MvcHtmlString("<a class=\"passportEditDialog\" id=\"passportEdit\" data-date-format=\"dd.mm.yy\" href=\"/Passport/EditDate/5?searchString=\">20.12.2014</a>");
