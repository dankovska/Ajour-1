...
namespace AjourBT.Tests.Helpers
{
    ...
    public class CustomCheckVisaToBeValidTest
    {
        ...
        public void CheckVisaToBeValid_empVisaNotNull_VisaNotExpired()
        {
            ...
            string searchString = "";
            string resString = String.Format("<a class=\"ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only\" id=\"AddPrivateTrip\"  data-date-format=\"dd.mm.yy\" href=\"{0}{1}?searchString={2}\"> Add </a>", "/PrivateTrip/Create/", emp.EmployeeID, searchString);
