...
namespace AjourBT.Tests.MockRepository
{
    public static class Mock_Repository
    {
        ...
        public static void Setup()
        {
            ...
            AddEmployee(new Employee { EmployeeID = 9, FirstName = "Natalia", LastName = "Zamorrison", DepartmentID = 5, EID = "namo", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 10, FirstName = "Natalia", LastName = "Talee", DepartmentID = 5, EID = "tale", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 11, FirstName = "Oleg", LastName = "Talee", DepartmentID = 5, EID = "taee", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 12, FirstName = "Igor", LastName = "Woody", DepartmentID = 5, EID = "igwo", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 13, FirstName = "Igor", LastName = "Wooody", DepartmentID = 5, EID = "iwou", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 14, FirstName = "Igor", LastName = "Wooody", DepartmentID = 5, EID = "iwoo", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 15, FirstName = "Igor", LastName = "Woooody", DepartmentID = 5, EID = "iwooo", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 16, FirstName = "Ivan", LastName = "Petriv", DepartmentID = 5, EID = "iwpe", DateEmployed = new DateTime(2011, 04, 11), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 17, FirstName = "Chuck", LastName = "Petrenko", DepartmentID = 1, EID = "chap", DateEmployed = new DateTime(2010, 04, 10), IsManager = false, BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 18, FirstName = "Ivan", LastName = "Test", DepartmentID = 1, EID = "ivte", DateEmployed = new DateTime(), BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 19, FirstName = "Sick", LastName = "Only", DepartmentID = 5, EID = "siol", DateEmployed = new DateTime(), BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 20, FirstName = "PaidVac", LastName = "Only", DepartmentID = 5, EID = "pvol", DateEmployed = new DateTime(), BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            AddEmployee(new Employee { EmployeeID = 21, FirstName = "UPaidVac", LastName = "Only", DepartmentID = 5, EID = "uvol", DateEmployed = new DateTime(), BusinessTrips = new List<BusinessTrip>(), CalendarItems = new List<CalendarItem>(), Overtimes = new List<Overtime>(), Vacations = new List<Vacation>(), Sicknesses = new List<Sickness>() });
            ...
            positions.Find(l => l.PositionID == 3).Employees.Add(employees.Find(e => e.EmployeeID == 8));
             ...
             AddBusinessTrip(new BusinessTrip { BusinessTripID = 14, StartDate = new DateTime(2014, 12, 12), EndDate = new DateTime(2014, 12, 13), OrderStartDate = new DateTime(2014, 12, 11), OrderEndDate = new DateTime(2014, 12, 14), LastCRUDedBy = "ncru", LastCRUDTimestamp = new DateTime(2012, 12, 02), Status = BTStatus.Confirmed | BTStatus.Modified, EmployeeID = 7, LocationID = 1, UnitID = 1, Comment = "7 employee conf + modif", Manager = "xtwe", Purpose = "meeting", Habitation = "krakow", HabitationConfirmed = true, Journeys = new List<Journey>() });
             ...
             AddBusinessTrip(new BusinessTrip { BusinessTripID = 16, StartDate = new DateTime(2014, 12, 01), EndDate = new DateTime(2014, 12, 26), OrderStartDate = new DateTime(2014, 11, 30), OrderEndDate = new DateTime(2014, 12, 27), DaysInBtForOrder = ((new DateTime(2014, 12, 27)).Date - (new DateTime(2014, 11, 30)).Date).Days + 1, LastCRUDedBy = "ncru", LastCRUDTimestamp = new DateTime(2012, 12, 02), UnitID = 1, Status = BTStatus.Confirmed | BTStatus.Reported, EmployeeID = 14, LocationID = 1, Comment = "7 employee conf and reported", Manager = "xtwe", Purpose = "meeting", Journeys = new List<Journey>() });
             ...
             AddBusinessTrip(new BusinessTrip { BusinessTripID = 33, StartDate = new DateTime(2013, 10, 01), EndDate = new DateTime(2013, 10, 05), OrderStartDate = new DateTime(2013, 09, 30), OrderEndDate = new DateTime(2014, 10, 06), LastCRUDedBy = "ncru", LastCRUDTimestamp = new DateTime(2012, 12, 02), Status = BTStatus.Confirmed | BTStatus.Reported, EmployeeID = 5, LocationID = 1, UnitID = 1, Comment = "7 employee conf and reported", Manager = "xtwe", Purpose = "meeting", Journeys = new List<Journey>() });
           ...
           //AddVisaRegistrationDate(new VisaRegistrationDate { EmployeeID = 17, RegistrationDate = new DateTime(2013, 01, 04), VisaType = "D08" });
            ...
            AddVisa(new Visa { EmployeeID = 2, VisaType = "C07", StartDate = DateTime.Now.ToLocalTimeAzure(), DueDate = DateTime.Now.ToLocalTimeAzure().AddDays(365), Days = 90, DaysUsedInBT = 0, DaysUsedInPrivateTrips = 0, Entries = 0, EntriesUsedInBT = 0, EntriesUsedInPrivateTrips = 0, VisaOf = employees.Find(e => e.EmployeeID == 2), PrivateTrips = new List<PrivateTrip>() });
         ...
         //   AddPassport(new Passport { EmployeeID = 3 });
            ...
            mock.Setup(m => m.Permits).Returns(permits.AsQueryable());
            ...
            mock.Setup(m => m.Passports).Returns(passports.AsQueryable());
            mock.Setup(m => m.Positions).Returns(positions.AsQueryable());
            mock.Setup(m => m.PrivateTrips).Returns(privateTrips.AsQueryable());
            mock.Setup(m => m.Countries).Returns(countries.AsQueryable());
            mock.Setup(m => m.Journeys).Returns(journeys.AsQueryable());
            mock.Setup(m => m.Holidays).Returns(holidays.AsQueryable());
            mock.Setup(m => m.Units).Returns(units.AsQueryable());
            mock.Setup(m => m.Overtimes).Returns(overtimes.AsQueryable());
