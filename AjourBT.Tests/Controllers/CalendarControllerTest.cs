...
namespace AjourBT.Tests.Controllers
{
    ...
    public class CalendarControllerTest
    {
        ...
        {
            //Arrange
            List<DateTime> exHolidaysList = (from holiday in mock.Object.Holidays where (holiday.CountryID == 1) orderby holiday.HolidayDate select holiday.HolidayDate).ToList();
